        ...
        <div>
            ...
            <div className="bg-gray-100 pt-12 pb-6" style={{ backgroundImage: 'url(bg-masukan.png)', backgroundSize: 'cover', backgroundPosition: 'center', minHeight:'100vh' }}>
                ...
                >
                    ...
                    <button
                        type="submit"
                        className="focus:outline-none text-white bg-green-700 hover:bg-green-900 focus:ring-4 focus:ring-green-300 font-medium rounded-lg text-sm px-10 py-2.5 me-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 text-center"
                    >
                        Kirim
                    </button>
                </motion.form>
